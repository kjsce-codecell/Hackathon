...
(function () {
    ...
    var _visMap = new Map();
    var _visObs = new IntersectionObserver(
        function (entries) {
            entries.forEach(function (e) {
                _visMap.set(e.target, e.isIntersecting);
            });
        },
        { rootMargin: "100px" },
    );
    ...
    `;
        ...
        function resize() {
            ...
            cursorCanvas.width = Math.max(
                1,
                Math.floor(window.innerWidth * dpr),
            );
            cursorCanvas.height = Math.max(
                1,
            ...
            if (footer) {
                ...
                if (r.top < fadeStart) {
                    t = Math.min(
                        ...
                        Math.max(
                            0,
                            (fadeStart - r.top) / (fadeStart - fadeEnd),
                        ),
                    );
                }
            }
...
`;
        ...
        const u = {
            ...
            uScanlineIntensity: gl.getUniformLocation(
                program,
                "uScanlineIntensity",
            ),
            ...
            uChromaticAberration: gl.getUniformLocation(
                program,
            ...
            uPageLoadProgress: gl.getUniformLocation(
                program,
                "uPageLoadProgress",
            ),
            uUsePageLoadAnimation: gl.getUniformLocation(
                program,
        ...
        if (
            ...
            typeof window.isTouchScreenDevice === "function"
        ) {
        ...
        function resize() {
            ...
            canvas.width = Math.max(
                1,
                Math.floor(canvas.parentElement.offsetWidth * dpr),
            );
            canvas.height = Math.max(
                1,
                Math.floor(canvas.parentElement.offsetHeight * dpr),
            );
            ...
            gl.uniform1f(
                u.uUsePageLoadAnimation,
                params.pageLoadAnimation ? 1 : 0,
            );
                ...
                if (ri < rings.length - 1) {
                    ...
                    ring.nodes.forEach((n1) => {
                        ...
                        nextRing.nodes.forEach((n2) => {
                            const x2 =
                                nextRing.cx +
                                Math.cos(n2.angle) * nextRing.radius;
                            const y2 =
                                nextRing.cy +
                                Math.sin(n2.angle) * nextRing.radius;
    ...
    function initScrollFadeIn() {
        ...
        if (scrollHint) {
            window.addEventListener(
                "scroll",
                () => {
                    scrollHint.style.opacity = Math.max(
                        0,
    ...
    function initAnnouncements() {
        ...
        function showHint() {
            bar.textContent =
                "Hint: Try dragging over certain numbers to progress in the game!";
            bar.classList.add("visible");
    ...
    function initTimelineLineDraw() {
        ...
        const threadWrap = timelineSection.querySelector(
        ...
        const threadPath = timelineSection.querySelector(
            "#timeline-thread-path",
        );
        const timelinePanels =
            timelineSection.querySelector(".timeline-panels");
        const nodes = Array.from(
            timelineSection.querySelectorAll(".timeline-node"),
        );
        ...
        const panelTitle = timelineSection.querySelector(
        ...
        let activeIndex = nodes.findIndex((node) =>
        ...
        function animatePanels(direction) {
            ...
            const animationClass =
                direction > 0 ? "panel-in-right" : "panel-in-left";
            ...
            panelAnimationTimeout = window.setTimeout(() => {
                timelinePanels.classList.remove(
                    "panel-in-left",
                    "panel-in-right",
                );
        ...
        document.addEventListener("click", () => {
            ...
            if (clickCount >= 3) {
                ...
                if (
                    ...
                    return;
                showFlashMessage(
                    "YOU FOUND A SECRET. THE CODE REMEMBERS.",
                    RED,
                );
            }
        });
    ...
    function initMusicDanceExperience() {
        ...
        if (!audio.src || !audio.src.endsWith(".mp3"))
            audio.src = "audio-assets/shakey-jake.mp3";
        audio.volume = 0.3;
      ...
      `;
            ...
            requestAnimationFrame(() => {
                musicUIContainer.style.opacity = "1";
            });
    ...
    function initIdleMessage() {
      ...
      white-space: nowrap;
    `;
        idleMsg.innerHTML = "&gt; STILL HERE? THE HACKATHON WON'T WAIT.";
    ...
    `;
        ...
        document.querySelectorAll(".timeline-item").forEach((item) => {
            ...
            item.querySelectorAll("._line-trace").forEach((line) =>
                line.remove(),
            );
        });
        ...
        const heads = [
            {
                ...
                role: "COMMITTEE HEAD",
                dept: "COMPS/TY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Amandeep_2025-26_mskokk.png",
                profile: "#",
            },
            {
                name: "VIRAJ BHARTIYA",
                role: "COMMITTEE HEAD",
                dept: "COMPS/TY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Viraj_2025-26_kgsta2.png",
                profile: "#",
            },
            {
                name: "OMIK ACHARYA",
                role: "TECH HEAD",
                dept: "COMPS/TY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Omik_2025-26_adlfya.png",
                profile: "#",
            },
            {
                name: "ADITI SINGH",
                role: "CREATIVE HEAD",
                dept: "COMPS/TY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Aditi_2025-26_gsvrlk.png",
                profile: "#",
            },
            {
                name: "RISHI SHANBHAG",
                role: "MARKETING HEAD",
                dept: "COMPS/TY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Rishi_2025-26_gnrtnq.png",
                profile: "#",
            },
        ];
        ...
        const ty = [
            {
                ...
                role: "TECH",
                dept: "COMPS/TY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Aditya_2025-26_vmc2dt.png",
                profile: "#",
            },
            {
                name: "KUMAR TANAY",
                role: "TECH",
                dept: "COMPS/TY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Kumar_2025-26_w8yscq.png",
                profile: "#",
            },
            {
                name: "VIVEK JAIN",
                role: "TECH",
                dept: "COMPS/TY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Vivek_2025-26_i4xgki.png",
                profile: "#",
            },
            {
                ...
                role: "CREATIVE",
                dept: "COMPS/TY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Akanksha_2025-26_pdmjtu.png",
                profile: "#",
            },
            {
                name: "AMRIT NIGAM",
                role: "CREATIVE",
                dept: "COMPS/TY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Amrit_2025-26_nltrok.png",
                profile: "#",
            },
            {
                ...
                role: "MARKETING",
                dept: "COMPS/TY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Chaitanya_2025-26_f3qgfw.png",
                profile: "#",
            },
            {
                ...
                role: "MARKETING",
                dept: "IT/TY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Dharmik_2025-26_a13b2z.png",
                profile: "#",
            },
            {
                ...
                role: "MARKETING",
                dept: "COMPS/TY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Shreyans_2025-26_m0nlbw.png",
                profile: "#",
            },
        ];
        ...
        const sy = [
            {
                ...
                role: "TECH",
                dept: "COMPS/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Anmol_2025-26_qkg5qr.png",
                profile: "#",
            },
            {
                name: "ASHWERA HASAN",
                role: "TECH",
                dept: "COMPS/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Ashwera_2025-26_rms4js.png",
                profile: "#",
            },
            {
                ...
                role: "TECH",
                dept: "COMPS/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Samagra_2025-26_cqy358.png",
                profile: "#",
            },
            {
                ...
                role: "TECH",
                dept: "COMPS/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Shantanav_2025-26_ugqzt7.png",
                profile: "#",
            },
            {
                name: "TANUJ ADARKAR",
                role: "TECH",
                dept: "COMPS/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Tanuj_2025-26_iwjjra.png",
                profile: "#",
            },
            {
                name: "VINAYAK PAI",
                role: "TECH",
                dept: "COMPS/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Vinayak_2025-26_pldlzb.png",
                profile: "#",
            },
            {
                name: "AMEYA DEORE",
                role: "CREATIVE",
                dept: "CSBS/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Ameya_2025-26_nc2bz5.png",
                profile: "#",
            },
            {
                name: "PURVA POTE",
                role: "CREATIVE",
                dept: "CSBS/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Purva_2025-26_sjpa2m.png",
                profile: "#",
            },
            {
                ...
                role: "CREATIVE",
                dept: "COMPS/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Divyanshi_2025-26_cdbse0.png",
                profile: "#",
            },
            {
                name: "DHANYA SHUKLA",
                role: "CREATIVE",
                dept: "COMPS/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Dhanya_2025-26_av45wa.png",
                profile: "#",
            },
            {
                name: "ARSHIA DANG",
                role: "MARKETING",
                dept: "IT/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Arshia_2025-26_hhecpq.png",
                profile: "#",
            },
            {
                name: "PARTH PANWAR",
                role: "MARKETING",
                dept: "AIDS/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Parth_2025-26_bcvfpt.png",
                profile: "#",
            },
            {
                ...
                role: "MARKETING",
                dept: "AIDS/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Harshil_2025-26_rjavbn.png",
                profile: "#",
            },
            {
                name: "SAMAIRA SHARMA",
                role: "MARKETING",
                dept: "IT/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Samaira_2025-26_kqxjqq.png",
                profile: "#",
            },
            {
                ...
                role: "MARKETING",
                dept: "VLSI/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Shravika_2025-26_yu6xyd.png",
                profile: "#",
            },
            {
                ...
                role: "MARKETING",
                dept: "CSBS/SY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Srushti_2025-26_uylcpu.png",
                profile: "#",
            },
        ];
        ...
        const fy = [
            {
                ...
                role: "TECH",
                dept: "COMPS/FY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Bhoumik_2025-26_eshy5e.png",
                profile: "#",
            },
            {
                name: "DHRUV KUMAR",
                role: "TECH",
                dept: "COMPS/FY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Dhruv_2025-26_hwv5sg.png",
                profile: "#",
            },
            {
                name: "PRANAV MENDON",
                role: "TECH",
                dept: "COMPS/FY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Pranav_2025-26_jls7oh.png",
                profile: "#",
            },
            {
                name: "ANCHITA SAHU",
                role: "CREATIVE",
                dept: "IT/FY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Anchita_2025-26_bcupfe.png",
                profile: "#",
            },
            {
                name: "MITALI PAUL",
                role: "CREATIVE",
                dept: "COMPS/FY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Mitali_2025-26_r05g4e.png",
                profile: "#",
            },
            {
                ...
                role: "MARKETING",
                dept: "COMPS/FY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Rudrakshi_2025-26_jsscqn.png",
                profile: "#",
            },
            {
                name: "YASH AGROYA",
                role: "MARKETING",
                dept: "IT/FY",
                photo: "https://res.cloudinary.com/dpdccxppm/image/upload/q_30/Yash_2025-26_vrfzkx.png",
                profile: "#",
            },
        ];
